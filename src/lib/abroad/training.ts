...
export const TRAINING_CLIMATE: Record<string, TrainingClimate> = {
  ...
  turkey: { price: '€30–50 unlimited', language: 'Turkish; English is limited outside Istanbul and the resort towns.', joining: 'Informal.' },
...
export const BEGINNER: Record<string, string> = {
  ...
  konyaalti: 'Corvos Combat takes beginners; expect Turkish instruction and to learn by watching.',
