...
import { LOGOS, logoPath, type LogoId } from '@/lib/logos'
          ...
          return (
            ...
            >
              ...
              <img
                ...
                style={{
                  outline: selected ? `2px solid ${logo.accent}` : '2px solid transparent',
                  outlineOffset: '2px',
                }}
              />
              <span
                className="text-[0.6875rem]"
                style={{ color: selected ? logo.accent : 'var(--ink-muted)' }}
              >
                {logo.label}
              </span>
            </button>
